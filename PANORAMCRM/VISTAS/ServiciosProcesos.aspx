<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterTecnico.Master" AutoEventWireup="true" CodeBehind="ServiciosProcesos.aspx.cs" Inherits="PANORAMCRM.VISTAS.ServiciosProcesos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="container">
        <div class="col-md-12 cajas">
            <div class="col-md-12 text-center">
                <h3 class="card-description" style="margin-top: 10px;">Servicios en Proceso</h3>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
    ...
    <div class="col-lg-12 grid-margin cajas">
        <div class="card">
            <div class="card-body">
                <h2 class="card-description" style="margin-top: -40px;">Lista de servicios en proceso
